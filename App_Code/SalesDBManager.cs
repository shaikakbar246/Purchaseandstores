...
public class SalesDBManager
{
    ...
    //  public string UserName = "";
      ...
      {
          //conn.ConnectionString = @"SERVER=MOUNIKASRINIVAS;DATABASE=purchaseandstores;UID=sa;PASSWORD=Vyshnavi123;";
          //conn.ConnectionString = @" SERVER=49.50.65.160;DATABASE=purchaseandstores;UID=sa;PASSWORD=WHHWYE%23@^#%;";
          //Go4Hosting
          //conn.ConnectionString = @" SERVER=49.50.65.160;DATABASE=purchaseandstores;UID=sa;PASSWORD=Vyshnavi@123";
          conn.ConnectionString = @" SERVER=182.18.162.51;DATABASE=svf_stores;UID=sa;PASSWORD=Vyshnavi@123";
      }
